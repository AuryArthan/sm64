...
void render_hud_stars(void) {
    ...
    if (showX == 1) {
        if(widescreen_flag == 2){
			...
			print_text(GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(HUD_STARS_X) + 16 +5, HUD_TOP_Y, "*"); // 'X' glyph
		}else{
...
void render_hud_timer(void) {
    ...
    if(widescreen_flag == 2){
		print_text_fmt_int(GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(91)+hud_shift_right+15-6, 185+hud_shift_up, "%0d", timerMins);
		print_text_fmt_int(GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(71)+hud_shift_right+11-3, 185+hud_shift_up, "%02d", timerSecs);
		print_text_fmt_int(GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(37)+hud_shift_right+8, 185+hud_shift_up, "%d", timerFracSecs);
	}else if(widescreen_flag == 1){
		print_text_fmt_int(GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(91)+hud_shift_right+9-4, 185+hud_shift_up, "%0d", timerMins);
		print_text_fmt_int(GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(71)+hud_shift_right+7-2, 185+hud_shift_up, "%02d", timerSecs);
    ...
    if(widescreen_flag == 2){
		render_hud_tex_lut(GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(81)+hud_shift_right+14-6, 32-hud_shift_up, (*hudLUT)[GLYPH_APOSTROPHE]);
		render_hud_tex_lut(GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(46)+hud_shift_right+8-2, 32-hud_shift_up, (*hudLUT)[GLYPH_DOUBLE_QUOTE]);
	}else if(widescreen_flag == 1){
		render_hud_tex_lut(GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(81)+hud_shift_right+9-4, 32-hud_shift_up, (*hudLUT)[GLYPH_APOSTROPHE]);
		render_hud_tex_lut(GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(46)+hud_shift_right+5-1, 32-hud_shift_up, (*hudLUT)[GLYPH_DOUBLE_QUOTE]);
    }else{
