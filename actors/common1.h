...
extern const Gfx dl_power_meter_base_WS[];
extern const Gfx dl_power_meter_base_UWS[];
extern const Gfx dl_power_meter_health_segments_begin[];
extern const Gfx dl_power_meter_health_segments_begin_WS[];
extern const Gfx dl_power_meter_health_segments_begin_UWS[];
